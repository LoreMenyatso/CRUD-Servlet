...
<div class="container">
  <h3>Add Graduates Form</h3>
  	<p>Please fill all fields to successfully add a new graduate.</p>
  	
	<form action="ControllerServlet" method="GET" class="needs-validation" >
	<input type="hidden" name="command" value="addGraduates"/>
    ...
    <div class="form-group">
		...
		<input type="text" class="form-control" id="expertise" placeholder="Enter expertise" name="expertise" required="required">
		<div class="valid-feedback">Valid.</div>
   	    <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
		...
		<input type="text" class="form-control" id="education" placeholder="Enter education" name="education" required="required">
		<div class="valid-feedback">Valid.</div>
   	    <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
