...
<div class="container">
  <h3>Add Professionals Form</h3>
  	<p>Please fill all fields to successfully add a new professional.</p>
  	
	<form action="ControllerServlet" method="GET" class="needs-validation" >
	<input type="hidden" name="command" value="addProfessionals"/>
    ...
    <div class="form-group">
		...
		<input type="text" class="form-control" id="profession" placeholder="Enter profession" name="profession" required="required">
		<div class="valid-feedback">Valid.</div>
   	    <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
		<label for="experience">Experience:</label>
		<input type="text" class="form-control" id="experience" placeholder="Enter experience duration" name="experience" required="required">
		<div class="valid-feedback">Valid.</div>
   	    <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
		<label for="project">Project:</label>
		<input type="text" class="form-control" id="project" placeholder="Enter project(s) worked on" name="project" required="required">
		<div class="valid-feedback">Valid.</div>
   	    <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
