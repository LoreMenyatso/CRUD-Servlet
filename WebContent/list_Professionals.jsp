...
<head>
  ...
  <blockquote class="blockquote">
    <p3>A directory of all the registered IT Professionals.</p3>
    <footer class="blockquote-footer">2008-2020</footer>
			...
			<!-- buttons that search and add  -->
					...
					<div class="col">
   	    				<input type="button" value="Add Professional" onclick="window.location.href='add-professional-form.jsp'; return false;"
         ...
         <!-- search field and button -->
					...
					<div class="col">
	 			 	  	<form action="ControllerServlet" method="get">
	   			  		 <input type="hidden" name="command" value="searchProfessionals"/>
   		...
   		<br>
               ...
               <table class="table table-hover">
                ...
                <tr>
                     ...
                     <c:forEach var="tempProfessional" items="${PROFESSIONAL_LIST}">         
                         ...
                         <tr>
                                <td>${tempProfessional.first_name}</td>
                                <td>${tempProfessional.last_name}</td>
                                <td>${tempProfessional.profession}</td>
                                <td>${tempProfessional.experience}</td>
                                <td>${tempProfessional.project}</td>
                                <td>${tempProfessional.email}</td>
