...
<head>
  ...
  <blockquote class="blockquote">
    <p3>A directory of all the registered IT companies.</p3>
    <footer class="blockquote-footer">2020</footer>
			...
			<!-- buttons that search and add  -->
					...
					<div class="col">
   	    				<input type="button" value="Add Company" onclick="window.location.href='add-company-form.jsp'; return false;"
         ...
         <!-- search field and button -->
					...
					<div class="col">
	 			 	  	<form action="ControllerServlet" method="get">
	   			  		 <input type="hidden" name="command" value="searchCompanys"/>
   		...
   		<br>
               ...
               <table class="table table-dark table-striped">
                ...
                <tr>
                     ...
                     <c:forEach var="tempCompany" items="${COMPANY_LIST}">         
                         ...
                         <tr>
                                ...
                                <td>${tempCompany.status}</td>
                                <td>${tempCompany.activities}</td>
                                <td>${tempCompany.profile}</td>
                                <td>${tempCompany.employers}</td>
                                
                                <td>${tempCompany.email}</td>
                                
                                <td><a class="btn btn-success" href="${tempLink}">Update</a><br/>
                                <br> <a class="btn btn-danger" href="${deletLink}"onclick="if(!(confirm('Are you sure you want to delete this this student?')))return false">Delete</a>
                                </td>
                         </tr>
                         </c:forEach>
