...
<div class="container">
  <h3>Update Business Advisors Form</h3>
  	<p>Update business advisors below.</p>
  	
  	<form action="ControllerServlet" method="GET"  class="needs-validation" novalidate>
  	<input type="hidden" name="command" value="updateAdvisors"/>
  	<input type="hidden" name="AdvisorId" value="${THE_ADVISOR.id}"/>
  	
  	<div class="form-group">
		<label>First name:</label>
		<input type="text" class="form-control" placeholder="Enter firstname" name="firstName" 
		value= "${THE_ADVISOR.first_name}" required>
	...
	<div class="form-group">
		...
		value= "${THE_ADVISOR.last_name}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
	<div class="form-group">
		...
		value= "${THE_ADVISOR.email}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
