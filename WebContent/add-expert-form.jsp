...
<div class="container">
  <h3>Add Experts Form</h3>
  	<p>Please fill all fields to successfully add a new expert.</p>
  	
	<form action="ControllerServlet" method="GET" class="needs-validation" >
	<input type="hidden" name="command" value="addExperts"/>
    ...
    <div class="form-group">
		...
		<input type="text" class="form-control" id="qualifications" placeholder="Enter qualifications" name="qualifications" required="required">
		<div class="valid-feedback">Valid.</div>
   	    <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
