...
<div class="container">
  <h3>Update Undergraduates Form</h3>
  	<p>Update business Undergraduates.</p>
  	
  	<form action="ControllerServlet" method="GET"  class="needs-validation" novalidate>
  	<input type="hidden" name="command" value="updateUndergraduates"/>
  	<input type="hidden" name="UndergraduateId" value="${THE_UNDERGRADUATE.id}"/>
  	
  	<div class="form-group">
		<label>First name:</label>
		<input type="text" class="form-control" placeholder="Enter firstname" name="firstName" 
		value= "${THE_UNDERGRADUATE.first_name}" required>
	...
	<div class="form-group">
		...
		value= "${THE_UNDERGRADUATE.last_name}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
	<div class="form-group">
		<label>Last name:</label>
		<input type="text" class="form-control" placeholder="Enter lastName" name="expertise" 
		value= "${THE_UNDERGRADUATE.expertise}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
	<div class="form-group">
		<label>Last name:</label>
		<input type="text" class="form-control" placeholder="Enter lastName" name="experience" 
		value= "${THE_UNDERGRADUATE.experience}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
	<div class="form-group">
		...
		value= "${THE_UNDERGRADUATE.email}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
