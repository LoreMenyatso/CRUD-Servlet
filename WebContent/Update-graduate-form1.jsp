...
<div class="container">
  <h3>Update Graduates Form</h3>
	...
	<div class="form-group">
		...
		value= "${THE_GRADUATE.last_name}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
	<div class="form-group">
		<label>Expertise:</label>
		<input type="text" class="form-control" placeholder="Enter expertise" name="expertise" 
		value= "${THE_GRADUATE.expertise}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
	<div class="form-group">
		...
		value= "${THE_GRADUATE.experience}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
	<div class="form-group">
		...
		value= "${THE_GRADUATE.education}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
	<div class="form-group">
		...
		value= "${THE_GRADUATE.email}" required>
		<div class="valid-feedback">Valid.</div>
		<div class="invalid-feedback">Please fill out this field.</div>
	</div>
	 ...
	 <div class="form-group form-check">
        ...
        <input class="form-check-input" type="checkbox" name="remember" required="required"> I agree to that I have provided authentic details.
        <div class="valid-feedback">Valid.</div>
